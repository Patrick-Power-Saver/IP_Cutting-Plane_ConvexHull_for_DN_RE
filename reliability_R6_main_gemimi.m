...
%
%  状态验证：
%    ①上游同馈线节点: p_feeder=1, p_direct=0, q=1 → τ^SW  ✓
%    ②下游已重构恢复: p_feeder=1, p_direct=1, q=1 → τ^SW  ✓
%    ③下游未恢复:     p_feeder=1, p_direct=1, q=0 → τ^RP  ✓
%    ④其他馈线节点:   p_feeder=0              → 0   ✓
% ================================================================
fprintf('>> [7/8] 计算可靠性指标...\n');
...
p_direct_d = double(p_mat);   % 与 p_mat_d 等价，命名与 R5 一致
